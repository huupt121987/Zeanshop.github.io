			...
			<div class="form-three widget-shadow">
				<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" value="<?php echo $nguoi_dung->ho_ten ?>" class="form-control1" name="ho_ten" id="ho_ten" placeholder="Họ Và Tên">
					...
					<div class="form-group">
						...
						<?php  
							foreach ($loai_nguoi_dung as $ldsnd) 
							{
								
								$select = $ldsnd->ma_loai_nguoi_dung==$nguoi_dung->ma_loai_nguoi_dung?"selected":"";
						?>									
							<option value="<?php echo $ldsnd->ma_loai_nguoi_dung ?>" <?php echo $select ?>><?php echo $ldsnd->ten_loai_nguoi_dung ?></option>
						<?php 
							} 
						?>
						</select>
					...
					<div class="form-group">
						...
						<div class="col-sm-3 ">
							<input type="text" class="form-control1" value="<?php echo $nguoi_dung->ten_dang_nhap ?>" name="ten_dang_nhap" id="ten_dang_nhap" placeholder="Tên Đăng Nhập">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control1" value="<?php echo $nguoi_dung->email ?>" name="email" id="email" placeholder="Email">
							<div class="kiemtra" style="display:none">Vui Lòng Nhập Email *</div>
						</div>
					</div>
					<?php $chk1=$nguoi_dung->active==0?"checked":"" ?>
					<?php $chk2=$nguoi_dung->active==1?"checked":"" ?>
					<div class="form-group">
					<label for="radio" class="col-sm-2 control-label">Kích Hoạt *</label>
						<div class="col-sm-8">
							<div class="radio-inline"><label><input type="radio" name='active' <?php echo $chk2 ?> checked="checked" value="1">Kích Hoạt</label></div>
							<div class="radio-inline"><label><input type="radio" <?php echo $chk1 ?> name='active' value="0">Không</label></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="password" class="form-control1" value="<?php echo $nguoi_dung->password ?>"  id="password" name="password" placeholder="password">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="password" class="form-control1" value="<?php echo $nguoi_dung->password ?>"  id="repassword" name="re-password" placeholder="Re-password">
